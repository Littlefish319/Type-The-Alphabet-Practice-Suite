...
const FOUNDER_LINE = 'Founded by Haibo Yu';
...
export default function YunovaLanding() {
  useEffect(() => {
    ...
    upsertMeta(
      'description',
      'YUNOVA, LLC builds focused learning tools and simple, high-signal apps.'
    );
  }, []);
        ...
        <header className="flex items-center justify-between gap-6">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <div className="mt-0.5 text-[11px] font-bold uppercase tracking-widest text-slate-400">{FOUNDER_LINE}</div>
            </div>
          </div>
          <a
        ...
        <main className="mt-14">
          <div className="max-w-3xl">
            ...
            <div className="mt-6 flex flex-col sm:flex-row sm:items-center gap-3 text-sm text-slate-600">
              ...
              <span className="text-slate-500">Business website for Apple verification and customer contact.</span>
            </div>
          </div>
          ...
          <section className="mt-12 rounded-3xl border border-slate-200 bg-white/80 backdrop-blur p-7 shadow-xl">
            <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-6">
              <div className="max-w-2xl">
                <div className="text-xs font-black uppercase tracking-widest text-slate-400">Product</div>
                ...
                <div className="mt-4 text-sm text-slate-500">
                  Made by <span className="font-bold text-slate-700">Xiaoyu Tang</span>.
                </div>
                <div className="mt-4 text-sm text-slate-500">
